    ...
    .then((MapData) => {
      ...
      let dt = new DataTable("#MapList", {
        ...
        initComplete: function () {
          // allow columns to be filtered by group
          this.api()
            .columns(".col-filter")
            .every(function () {
              let column = this;
      ...
      function copyToClipboard(text, menu) {
        navigator.clipboard.writeText(text).then(() => {
          ...
          feedback.className =
            "position-fixed p-2 bg-success text-white rounded";
                    ...
                    <div class="border bg-dark-subtle rounded-top w-100">
                        <div class="mv-header bg-dark-subtle rounded-top py-2 px-3 border-bottom d-flex justify-content-between align-items-center">
                            <span>
                                ...
                                <span class="text-secondary ms-2 border rounded px-1 small">${
                                  map.File
                                }</span>
                            </span>
                            <span class="">
                                <div class="dropdown d-inline-block">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <button class="dropdown-item d-flex align-items-center share-url" data-url="${protocol}//${
          ...
          button.addEventListener("click", function () {
            ...
            navigator.clipboard.writeText(url).then(() => {
              ...
              feedback.style.cssText = `
                                ...
                                left: ${
                                  buttonRect.left - 110
                                }px;  // 90px for feedback width + 20px gap
                                z-index: 1001;
                            `;
              feedback.textContent = "URL Copied!";
              document.body.appendChild(feedback);
      ...
      document.addEventListener("keydown", function (e) {
        ...
        if (!currentRow.any()) {
          ...
          const currentIndex = Array.from(visibleRows).indexOf(
            currentRow.node()
          );
          ...
          if (e.key === "ArrowUp") {
            ...
            newRowIndex =
              currentIndex >= visibleRows.length - 1 ? 0 : currentIndex + 1;
          }
        }
